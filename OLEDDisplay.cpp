...
void OLEDDisplay::drawIco16x16(int16_t xMove, int16_t yMove,
  const char * ico, bool inverse) {
  uint16_t data;
...
void OLEDDisplay::setFontTableLookupFunction(FontTableLookupFunction
  function) {
